...
let largeShirts = [];
 largeShirts = runners.filter((last_name) =>{
    return last_name.shirt_size === "L";
}) 
...
ticketPriceTotal = runners.reduce((amount,currentValue)=> {
    return amount + currentValue.donation
},0);
